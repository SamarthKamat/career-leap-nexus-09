...
const Login = () => {
  ...
  const { login, signInWithGoogle, signInWithGitHub, currentUser } = useAuth();
  ...
  return (
    <>
      ...
      <div className="min-h-screen flex">
        ...
        <div className="hidden lg:block lg:w-1/2 bg-gradient-to-tr from-blue-800 to-purple-900">
          <div className="h-full flex items-center justify-center p-12">
            <div className="max-w-lg">
              <h2 className="text-4xl font-bold text-white mb-6">Start Your Career Journey Today</h2>
              <p className="text-lg text-gray-200 mb-8">Access personalized job recommendations, interview preparation tools, and career development resources.</p>
            </div>
          </div>
        </div>
      </div>
